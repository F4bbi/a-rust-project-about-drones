...
import CytoscapeContainer, {
  type CytoscapeContainerRef,
} from "./CytoscapeContainer";
...
const TopologyVisualizer = forwardRef<
  TopologyVisualizerRef,
  TopologyVisualizerProps
>(({ nodes, edges, onNodeSelect }, ref) => {
  ...
  useImperativeHandle(ref, () => ({
    ...
    removeNode: (nodeId: string) => {
      cytoscapeRef.current?.removeNode(nodeId);
    },
  }));
