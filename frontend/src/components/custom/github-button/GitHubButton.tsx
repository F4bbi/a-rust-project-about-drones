...
const GitHubButton: React.FC = () => {
  const handleClick = () => {
    window.open("https://github.com/F4bbi/a-rust-project-about-drones", "_blank", "noopener,noreferrer");
  };

  return (
    <div className="fixed top-0 right-22 z-10 pt-5 sm:right-22 sm:top-0 max-sm:right-5 max-sm:top-20">
      <button
        onClick={handleClick}
